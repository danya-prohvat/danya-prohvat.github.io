...
/* harmony import */ var _modules_ch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/ch */ "./src/js/modules/ch.js");
/* harmony import */ var _modules_sms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/sms */ "./src/js/modules/sms.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_ch__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="name"]');
  Object(_modules_ch__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="message"]'); // mask('[name="phone"]');

  Object(_modules_sms__WEBPACK_IMPORTED_MODULE_4__["default"])('.button-styles', '.styles-2');
    ...
    btn.addEventListener('click', function () {
      if (this.classList.contains('active-style')) {
        ...
        btns.forEach(function (a) {
          if (a.classList.contains('active-style')) {
            a.classList.remove('active-style');
            a.nextElementSibling.classList.remove('active-content');
...
var drop = function drop() {
  ...
  function highlight(item) {
    item.closest('.file_upload').style.border = "1px solid #7B68EE";
...
var filter = function filter() {
  ...
  var typeFilter = function typeFilter(markType) {
    wrapper.querySelectorAll('.all').forEach(function (mark) {
    ...
    if (markType == 'grandmother' || markType == 'granddad') {
      no.style.display = 'block';
      no.classList.add('animated', 'fadeIn');
    } else if (markType) {
      wrapper.getElementsByClassName(markType).forEach(function (mark) {
  ...
  items.forEach(function (item) {
    item.addEventListener('click', function (e) {
      var target = e.target;
      typeFilter(target.classList.value);
...
var modals = function modals() {
  ...
  function bindModal(triggerSelctor, modalSelctor, closeSelctor) {
    var destroy = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var trigger = document.querySelectorAll(triggerSelctor),
        close = document.querySelector(closeSelctor),
...
var sms = function sms(trigger, styles) {
...
/* harmony default export */ __webpack_exports__["default"] = (sms);
